...
Device name	DESKTOP-EI352G4
Processor	11th Gen Intel(R) Core(TM) i3-1115G4 @ 3.00GHz   3.00 GHz
Installed RAM	8.00 GB (7.56 GB usable)
Device ID	606FB14B-1459-403D-A9AF-AE2BA8473E9E
Product ID	00356-02771-78852-AAOEM
System type	64-bit operating system, x64-based processor


Define or describe usage of Computer using Computer Programs. Pictures are preferred over a lot of text.  Use your experience.
Input device: An input device is a device that is used to input data into a computer. Examples of input devices include keyboards, mice, and microphones.
